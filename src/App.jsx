    ...
    <div className="site">
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logoWrap { width: 92px; height: 92px; border-radius: 50%; padding: 5px; background: linear-gradient(135deg, #42b35e, #ffffff22, #0b0b0b); box-shadow: 0 0 0 1px rgba(255,255,255,.08), 0 14px 35px rgba(255,106,0,.18); flex-shrink: 0; }
        ...
        .quoteBtn, .orangeBtn { background: linear-gradient(135deg, #42b35e, #67d982); color: #000; font-weight: 900; padding: 18px 30px; border-radius: 999px; box-shadow: 0 12px 30px rgba(255,106,0,.28); display: inline-block; transition: .25s ease; }
        ...
        .card:hover { transform: translateY(-8px); border-color: rgba(66,179,94,.45); box-shadow: 0 22px 50px rgba(66,179,94,.08); }
        ...
        .productIcon { height: 280px; background: #191a1e; border-radius: 24px; display: flex; align-items: center; justify-content: center; font-size: 78px; margin-bottom: 32px; overflow: hidden; }
        .productImageWrap img { width: 100%; height: 100%; object-fit: cover; transition: transform .45s ease; }
