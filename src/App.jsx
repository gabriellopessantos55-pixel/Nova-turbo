    ...
    <div className="site">
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card { background: #101c13; border: 1px solid #1f3525; border-radius: 34px; padding: 30px; transition: .3s ease; }
        ...
        .productsSection { border-top: 1px solid #1f3525; border-bottom: 1px solid #1f3525; max-width: 100%; padding-left: max(16px, calc((100vw - 1220px) / 2)); padding-right: max(16px, calc((100vw - 1220px) / 2)); background: #09170d; }
        ...
        .productIcon { height: 280px; background: #101c13; border-radius: 24px; display: flex; align-items: center; justify-content: center; font-size: 78px; margin-bottom: 32px; overflow: hidden; }
